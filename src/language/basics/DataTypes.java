...
public class DataTypes {
	...
	//	Temperature of a city in degrees Celsius:
		float temperatureOfACity = 25.5f;
		System.out.println(temperatureOfACity);
		
	//	Whether a customer has placed an order:	
		boolean customerPlacedOrder = true;
	...
	// Person's marital status: true or false
		...
		boolean personMaritalStatus =false;
		System.out.println("Person's marital status: " + maritalStatus);
		System.out.println("Person's marital status: " + personMaritalStatus);
	...
	//	16.Time of an event: 2:30 PM
		  String event = "2:30PM";
		  System.out.println("Time of an event: "+ event);
